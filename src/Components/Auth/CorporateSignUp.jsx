...
const CorporateSignUp = ({ onBack }) => {
  ...
  const validateForm = () => {
    ...
    } else if (!/^RC\d+$/i.test(formData.rcNumber)) {
      newErrors.rcNumber = 'RC Number should start with RC followed by numbers (e.g., RC123456)';
    }
        ...
        <div className="bg-white/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl shadow-green-500/10 p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500 text-base">
              Enter your business information to create your account
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {/* RC Number */}
            <div>
              <label htmlFor="rcNumber" className="block text-sm font-medium text-slate-700 mb-2">
              ...
              <input
                ...
                onChange={handleInputChange}
                placeholder="Enter your RC number (e.g., RC123456)"
                className={`w-full px-4 py-3 border-2 rounded-xl bg-white text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-4 transition-all duration-200 ${
                  errors.rcNumber 
                    ? 'border-red-300 focus:border-red-500 focus:ring-red-500/10' 
                    : 'border-slate-200 focus:border-green-600 focus:ring-green-600/10'
              ...
              />
              {errors.rcNumber && <p className="mt-2 text-sm text-red-600">{errors.rcNumber}</p>}
            </div>
